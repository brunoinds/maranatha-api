...
namespace App\Support\Creators\Inventory\WarehouseOutcomeRequestReceivedProducts;
...
class WarehouseOutcomeRequestReceivedProductsPdfCreator
{
    private $html = '';
    ...
    private function loadTemplate($options = ['withImages' => true])
    {
        if ($options['withImages']){
            $this->html = file_get_contents(base_path('app/Support/Creators/Inventory/WarehouseOutcomeRequestReceivedProducts/Templates/WithImages.html'));
        }else{
            $this->html = file_get_contents(base_path('app/Support/Creators/Inventory/WarehouseOutcomeRequestReceivedProducts/Templates/WithoutImages.html'));
        }
    }
    ...
    private function loadReceivedImage()
    {
